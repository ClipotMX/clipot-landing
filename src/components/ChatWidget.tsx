...
import { MessageCircle, X, Send, Phone, Copy } from "lucide-react";
    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
        >
          {showActions || isOpen ? <X size={24} /> : <MessageCircle size={24} />}
        </motion.button>
        ...
        <AnimatePresence>
          {showActions && !isOpen && (
            ...
            >
              <button
                className="w-12 h-12 rounded-full bg-primary text-primary-foreground shadow-md ring-1 ring-border flex items-center justify-center"
                onClick={() => {
                  setIsOpen(true);
                  setShowActions(false);
                }}
              ...
              <a
                href="https://wa.me/525512345678?text=Hola%20Clipot%2C%20quiero%20mejorar%20mi%20ROI%20y%20ventas"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-full bg-green-500 text-white shadow-md ring-1 ring-green-600 flex items-center justify-center"
