...
const tiers = [
  {
    name: "Nucleus Lite",
    description: "Sistemas de punto de venta y flujos básicos de operación.",
    features: [
      "Implementación de POS Digital",
  ...
  },
  {
    ...
    description: "Integración profunda de CRM, ERP y Estrategia de Pauta.",
    features: [
      "CRM (Kommo/Hubspot) Setup",
